...
const WelcomePage = () => {
    return (
        <div className="container mx-auto py-8 bg-white-80 flex flex-col md:flex-row justify-start items-start shadow-sm rounded border border-gray-200 my-16">
            <div className="text-start p-8 bg-white max-w-2xl">
                <h1 className="text-2xl font-bold mb-4 text-primary">Welcome, Chan Tola!</h1>
            ...
            <div className="mt-8 md:mt-0 md:ml-8">
                <Image src="/img.png" alt="Welcome" width="500" height="473"/>
            </div>
        </div>
    );
};
