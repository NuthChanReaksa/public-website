        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6  ">
                {programs.map((program, index) => (
                    <div key={index} className="relative h-full transition-transform duration-300 cursor-pointer hover:scale-105">
                        <Image src={program.image} alt={program.title} width={500} height={600} className="w-full h-full object-cover rounded-lg" />
