...
const EventComponent = () => {
    const news = [
        ...
        {
            title: "កម្មវិធី សង្ក្រាន្តឆ្នាំថ្មី​ និង​ពិសាអាហារសាមគ្គីភាតរភាពរបស់គ្រួសារ CSTAD នាថ្ងៃព្រហស្បតិ៍  ទី១១...",
            location: "Phnom Penh",
            date: "October 22, 2023",
                ...
                {news.map((item, index) => (
                    <div key={index} className="bg-white shadow-sm rounded-lg overflow-hidden">
                        <div className="grid grid-cols-1 md:grid-cols-2 transition hover:scale-105">
                            <div className="h-36 md:h-auto overflow-hidden relative w-full">
                                <Image
                                    src={item.image}
                                    alt={item.title}
                                    layout="fill"
                            ...
                            <div className="p-6">
                                ...
                                <Link href="#" passHref>
                                    <button className="text-primary hover:text-blue-700 mt-4 inline-block">
                                        Read More
                                    </button>
                                </Link>
                            </div>
