...
export default function Gallery() {
    ...
    return (
        <div className="container mx-auto my-24 px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="relative z-10 grid lg:grid-cols-3 lg:grid-rows-1 gap-4">
                ...
                <div data-aos="fade-up" className="lg:col-span-1 lg:row-span-2">
                ...
                <div data-aos="fade-down-right" className="lg:col-span-1 lg:row-span-2 grid grid-rows-2 gap-4">
                ...
                <div data-aos="fade-down-left" className="lg:col-span-1 lg:row-span-2 pb-16 pl-8 small:hidden">
                    <Image
                        className="h-auto max-w-full"
